  ...
  return (
    <div>
        <form className="geoLocationForm">
            <div>
                <label>By selecting this checkbox, I agree to allow access to my location / Geolocation to be used to determine distances to the schools listed below. You can change your preferences in your browsers settings panel.</label>
            </div>
            <div>
